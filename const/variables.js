...
const TRANSACTION_TYPE_CHECKOUT_CANCEL_SALE = "6";
...
const PAYMENT_STATE_ACTIVE = "1";
const PAYMENT_STATE_CANCELLED = "2";

const DISCOUNT_STATE_ACTIVE = "1";
const DISCOUNT_STATE_CANCELLED = "2";
...
module.exports = {
    ...
    DISCOUNT_STATE_ACTIVE,
    DISCOUNT_STATE_CANCELLED,
    IS_NULL,
    HTTP_200,
    HTTP_400,
    HTTP_403,
